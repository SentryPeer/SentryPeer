...
int main(void)
{
	...
	const struct CMUnitTest tests[] = {
		...
		cmocka_unit_test(test_sip_send_reply_correlates_request_headers),
		cmocka_unit_test(test_sip_send_reply_adds_to_tag_when_missing),
		cmocka_unit_test(test_sip_send_reply_survives_embedded_nul_byte),
